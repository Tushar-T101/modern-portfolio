...
const Projects: React.FC = () => (
	<section id="projects" className="relative z-50 my-12 lg:my-24 bg-white dark:bg-gray-950">
		...
		<div className="pt-24">
			<div className="flex flex-col gap-6" style={{ paddingBottom: `${stickyOffset + cardSpacing}px` }}>
				{projects.map((proj, idx) => (
					...
					>
						<div className="box-border flex items-center justify-center rounded shadow-[0_0_30px_0_rgba(0,0,0,0.08)] transition-all duration-[0.5s] bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
							<div className="relative rounded-lg w-full">
								{/* Gradient lines */}
								<div className="flex flex-row">
									<div className="h-[1px] w-full bg-gradient-to-r from-transparent via-blue-300 to-blue-100 dark:via-blue-900 dark:to-blue-950"></div>
									<div className="h-[1px] w-full bg-gradient-to-r from-blue-100 dark:from-blue-950 to-transparent"></div>
								</div>
								{/* Header */}
								<div className="px-4 lg:px-8 py-3 lg:py-5 relative">
									<div className="flex flex-row space-x-1 lg:space-x-2 absolute top-1/2 -translate-y-1/2">
										<div className="h-2 w-2 lg:h-3 lg:w-3 rounded-full bg-blue-400 dark:bg-yellow-400"></div>
										<div className="h-2 w-2 lg:h-3 lg:w-3 rounded-full bg-blue-200 dark:bg-yellow-200"></div>
										<div className="h-2 w-2 lg:h-3 lg:w-3 rounded-full bg-green-200 dark:bg-green-700"></div>
									</div>
									<p className="text-center ml-10 text-blue-700 dark:text-yellow-400 text-base lg:text-xl font-semibold">
										{proj.name}
									</p>
								</div>
								{/* Code-like body */}
								<div className="overflow-hidden border-t-[2px] border-gray-200 dark:border-gray-700 px-4 lg:px-8 py-4 lg:py-8 bg-white dark:bg-gray-900">
									<code className="font-mono text-xs md:text-sm lg:text-base text-gray-900 dark:text-gray-100">
										<div>
